...
const TRANSLATIONS = {
  ja: {
    ...
    gearCompareTitle:'武具対照 / COMPARISON', cmpApply:'採用', cmpReset:'復元', cmpCancel:'離脱', cmpCurrent:'現有', cmpNew:'新置',
  ...
  en: {
    ...
    gearCompareTitle:'COMPARISON', cmpApply:'Apply', cmpReset:'Revert', cmpCancel:'Cancel', cmpCurrent:'CURRENT', cmpNew:'NEW',
  ...
  zh: {
    ...
    gearCompareTitle:'武具对照 / COMPARISON', cmpApply:'采用', cmpReset:'还原', cmpCancel:'退出', cmpCurrent:'现有', cmpNew:'新置',
  ...
  ko: {
    ...
    gearCompareTitle:'무구대조 / COMPARISON', cmpApply:'적용', cmpReset:'복원', cmpCancel:'취소', cmpCurrent:'현재', cmpNew:'신규',
