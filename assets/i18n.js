...
const TRANSLATIONS = {
  ja: {
    ...
    martialIndex:'武格指数', martialIndexSub:'MARTIAL INDEX', martialHistoryTab:'武格履歴', historyEmpty:'まだ履歴がありません。インポート時に自動記録されます。', qualityTab:'ロール品質', qualityEmpty:'インポート後 装備データから品質を表示', minElemSub:'最小属性攻撃(副)', maxElemSub:'最大属性攻撃(副)',
  ...
  en: {
    ...
    martialIndex:'Martial Index', martialIndexSub:'MARTIAL INDEX', martialHistoryTab:'Martial Record', historyEmpty:'No history yet. Will auto-record on import.', qualityTab:'Roll Quality', qualityEmpty:'Quality will display after import', minElemSub:'Sub Elem ATK Min', maxElemSub:'Sub Elem ATK Max',
  ...
  zh: {
    ...
    martialIndex:'武格指数', martialIndexSub:'MARTIAL INDEX', martialHistoryTab:'武格履历', historyEmpty:'暂无记录。导入时将自动记录。', qualityTab:'装备品质', qualityEmpty:'导入后从装备数据显示品质', minElemSub:'最小属性攻击(副)', maxElemSub:'最大属性攻击(副)',
  ...
  ko: {
    ...
    martialIndex:'무격 지수', martialIndexSub:'무격 지수', martialHistoryTab:'무격 이력', historyEmpty:'아직 기록이 없습니다. 가져오기 시 자동 기록됩니다.', qualityTab:'롤 품질', qualityEmpty:'가져오기 후 장비 데이터로 품질 표시', minElemSub:'최소 속성 공격(부)', maxElemSub:'최대 속성 공격(부)',
