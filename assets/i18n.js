...
const TRANSLATIONS = {
  ja: {
    pageTitle:'風燕計 | WWM-METRICS', headerTitle:'風燕計', brandVert:'風燕計',
    ...
    donutCenter:'P · 確率分布', donutDmgCenter:'SCORE RATIO',
    ...
    affixRankingTab:'調律/定音期待値', affixRankingTitle:'調律/定音期待値ランキング',
    ...
    diagPenBoth:'外功/属性 どちらにも特化なし → 片方に特化推奨 (外功貫通+1={0} / 属性貫通+1={1} / 推奨 外功≥22 or 属性≥18)',
    ...
    importBmLabel:'📥 WWM-DMGCALC インポート',
    ...
    martialIndex:'武格指数', martialHistoryTab:'武格履歴', historyEmpty:'まだ履歴がありません。インポート時に自動記録されます。',
    locale:'ja-JP',
  },
  en: {
    pageTitle:'Where Winds Metrics | WWM', headerTitle:'Where Winds Metrics', brandVert:'風燕計',
    headerSub:'WWM-REAL-TIME-METRICS',
    ...
    donutCenter:'P · Distribution', donutDmgCenter:'SCORE RATIO',
    ...
    diagPenBoth:'Neither Phys nor Elem path specialized → recommend focus (PhysPen+1={0} / ElemPen+1={1} / recommend Phys≥22 or Elem≥18)',
    ...
    importBmLabel:'📥 WWM-DMGCALC Import',
    ...
    martialIndex:'Martial Index', martialHistoryTab:'Martial Record', historyEmpty:'No history yet. Will auto-record on import.',
    locale:'en-US',
  },
  zh: {
    pageTitle:'燕云计 | WWM-METRICS', headerTitle:'燕云计', brandVert:'燕云计',
    headerSub:'WWM-REAL-TIME-METRICS',
    ...
    donutCenter:'P · 概率分布', donutDmgCenter:'SCORE RATIO',
    ...
    diagGood:'主要属性良好',
    diagPenBoth:'外攻/属性 均未特化 → 建议专注其一 (外攻穿透+1={0} / 属性穿透+1={1} / 推荐 外攻≥22 或 属性≥18)',
    ...
    martialIndex:'武格指数', martialHistoryTab:'武格履历', historyEmpty:'暂无记录。导入时将自动记录。',
    locale:'zh-CN',
  },
  ko: {
    pageTitle:'연운계 | WWM-METRICS', headerTitle:'연운계', brandVert:'연운계',
    headerSub:'WWM-REAL-TIME-METRICS',
    ...
    donutCenter:'P · 확률 분포', donutDmgCenter:'SCORE RATIO',
    ...
    diagGood:'주요 스탯은 양호',
    diagPenBoth:'외공/속성 모두 특화 없음 → 한쪽 특화 권장 (외공관통+1={0} / 속성관통+1={1} / 권장 외공≥22 또는 속성≥18)',
    ...
    importBmLabel:'📥 WWM-DMGCALC 가져오기',
    ...
    martialIndex:'무격 지수', martialHistoryTab:'무격 이력', historyEmpty:'아직 기록이 없습니다. 가져오기 시 자동 기록됩니다.',
    locale:'ko-KR',
  },
};
