...
const _STAT_LABELS_I18N = {
  ...
  en: {
    ...
    bleed: 'Change SD Bleed',
    moBladeShield: 'Soulrend MB Shield',
    panaceaFanHealing: 'Panacea FN Heal',
    swordQ: 'Change SD Q', swordCharged: 'Change SD Ch', swordSpecial: 'Change SD Sp',
    namelessSwordQ: 'Nameless SD Q', namelessSwordCharged: 'Nameless SD Ch', namelessSwordSpecial: 'Nameless SD Sp',
    spearQ: 'Serpent SP Q', spearCharged: 'Serpent SP Ch', spearSpecial: 'Serpent SP Sp',
    namelessSpearQ: 'Nameless SP Q', namelessSpearCharged: 'Nameless SP Ch', namelessSpearSpecial: 'Nameless SP Sp',
    stormbreakerQ: 'Storm SP Q', stormbreakerCharged: 'Storm SP Ch', stormbreakerSpecial: 'Storm SP Sp',
    fanQ: 'Inkbrush FN Q', fanCharged: 'Inkbrush FN Ch', fanSpecial: 'Inkbrush FN Sp',
    panaceaFanQ: 'Panacea FN Q', panaceaFanSpecial: 'Panacea FN Sp',
    moBladeCharged: 'Soulrend MB Ch', moBladeSpecial: 'Soulrend MB Sp',
    phalanxbaneQ: 'Phalanx MB Q', phalanxbaneCharged: 'Phalanx MB Ch',
    snowpartingQ: 'Snowpart HB Q', snowpartingCharged: 'Snowpart HB Ch', snowpartingVariedCombo: 'Snowpart HB LA/HC',
    ...
    soulshadeUmbQ: 'Soulshade UM Q', soulshadeUmbCharged: 'Soulshade UM Ch', soulshadeUmbSpecial: 'Soulshade UM Sp',
    everspringUmbQ: 'Everspring UM Q', everspringUmbCharged: 'Everspring UM Ch', everspringUmbSpecial: 'Everspring UM Sp',
    mortalRopeDartQ: 'Mortal RD Q', mortalRopeDartCharged: 'Mortal RD Ch', mortalRopeDartRodent: 'Mortal RD Rodent',
    unfetteredRopeDartQ: 'Unfetter RD Q', unfetteredRopeDartCharged: 'Unfetter RD Ch', unfetteredRopeDartSpecial: 'Unfetter RD Sp'
  },
  zh: {
    body: '体', power: '会', agility: '速', momentum: '力', defense: '防御',
