...
const TRANSLATIONS = {
  ja: {
    ...
    donutCenter:'P · 確率分布', donutDmgCenter:'DMG · 寄与率',
  ...
  en: {
    ...
    donutCenter:'P · Distribution', donutDmgCenter:'DMG · Contribution',
  ...
  zh: {
    ...
    donutCenter:'P · 概率分布', donutDmgCenter:'DMG · 伤害占比',
  ...
  ko: {
    ...
    donutCenter:'P · 확률 분포', donutDmgCenter:'DMG · 기여율',
